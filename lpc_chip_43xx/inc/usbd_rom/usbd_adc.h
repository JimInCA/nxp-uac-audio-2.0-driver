...
/* Audio Function Class Code - A.? / A.1 */
#ifdef USB_AUDIO_2DOT0
#define AUDIO_AUDIO_FUNCTION                    AUDIO
#endif

/* Audio Function Subclass Codes - A.? / A.2 */
#ifdef USB_AUDIO_2DOT0
#define AUDIO_FUNCTION_SUBCLASS_UNDEFINED       0x00
#endif

/* Audio Function Protocal Codes - A.? / A.3 */
#ifdef USB_AUDIO_2DOT0
#define AUDIO_FUNCTION_PROTOCOL_UNDEFINED       0x00
#define AUDIO_AF_VERSION_02_00                  IP_VERSION_02_00
#endif

/* Audio Interface Class Code - A.1 / A.4 */
#define AUDIO                                   0x01

/* Audio Interface Subclass Codes - A.2 / A.5 */
...
/* Audio Interface Protocol Codes - A.3 / A.6 */
#ifndef USB_AUDIO_2DOT0
...
#ifdef USB_AUDIO_2DOT0
/* Audio Function Category Codes - A.? / A.7 */
#define AUDIO_FUNCTION_SUBCLASS_UNDEFINED       0x00
#define AUDIO_DESKTOP_SPEAKER                   0x01
#define AUDIO_HOME_THEATER                      0x02
#define AUDIO_MICROPHONE                        0x03
#define AUDIO_HEADSET                           0x04
#define AUDIO_TELEPHONE                         0x05
#define AUDIO_CONVERTER                         0x06
#define AUDIO_VOICE_SOUND_RECORDER              0x07
#define AUDIO_IO_BOX                            0x08
#define AUDIO_MUSICAL_INSTRUMENT                0x09
#define AUDIO_PRO_AUDIO                         0x0A
#define AUDIO_AUDIO_VIDEO                       0x0B
#define AUDIO_CONTROL_PANEL                     0x0C
#define AUDIO_OTHER                             0xFF
#endif

/* Audio Descriptor Types - A.4 / A.8 */
...
/* Audio Control Interface Descriptor Subtypes - A.5 / A.9 */
...
#define AUDIO_CONTROL_CLOCK_MULTIPLITER         0x0C
#define AUDIO_CONTROL_SAMPLE_RATE_CONVERTER     0x0D
#endif

/* Audio Streaming Interface Descriptor Subtypes - A.6 / A.10 */
...
#define AUDIO_STREAMING_DECODER                 0x04
#endif
...
/* Audio Effect Unit Effect Types - A.? / A.11 */
#ifdef USB_AUDIO_2DOT0
#define AUDIO_EFFECT_UNDEFINED                  0x00
#define AUDIO_EFFECT_PARAM_EQ_SELECTION_EFECT   0x01
...
/* Audio Processing Unit Process Types - A.7 / A.12 */
...
#else
#define AUDIO_STEREO_EXTENDER_PROCESS           0x03
#endif

/* Audio Endpoint Descriptor Subtypes - A.8 / A.13 */
#define AUDIO_ENDPOINT_UNDEFINED                0x00
#define AUDIO_ENDPOINT_GENERAL                  0x01

/* Audio Request Codes - A.9 / A.14 */
...
/* Audio Control Selector Codes - A.10 / A.17 */
#define AUDIO_CONTROL_UNDEFINED                 0x00    /* Common Selector */

/* Clock Source Control Selectors - A.10.? / A.17.1 */
#ifdef USB_AUDIO_2DOT0
...
/* Clock Selector Control Selectors - A.10.? / A.17.2 */
#ifdef USB_AUDIO_2DOT0
#define AUDIO_CX_CONTROL_UNDEFINED              0x00
#define AUDIO_CX_CLOCK_SELECTOR_CONTROL         0x01
#endif

/* Clock Multiplier Control Selector - A.10.? / A.17.4 */
#ifdef USB_AUDIO_2DOT0
#define AUDIO_CM_CONTROL_UNDEFINED              0x00
#define AUDIO_CM_NUMERATOR_CONTROL              0x01
#define AUDIO_DENOMINATOR_CONTROL               0x02
#endif

/*  Terminal Control Selectors - A.10.1 / A.17.4 */
#ifndef USB_AUDIO_2DOT0
...
/* Mixer Control Selectors - A.10.? / A.17.5 */
#ifdef USB_AUDIO_2DOT0
...
/* Selector Control Selectors - A.10.? / A.17.6 */
#ifdef USB_AUDIO_2DOT0
#define AUDIO_SU_CONTROL_UNDEFINED              0x00
#define AUDIO_SU_SELECTOR_CONTROL               0x01
#define AUDIO_SU_LATENCH_CONTROL                0x02
#endif

/*  Feature Unit Control Selectors A.10.2 / A.17.7 */
...
/* Effect Unit Control Selectors - A.10.? / A.17.8 */
#ifdef USB_AUDIO_2DOT0
#define AUDIO_EU_CONTROL_UNDEFINED              0x00
#endif

/* Parametric Equalizer Section Effect Unit Control Selectors - A.10.? / A.17.8.1 */
#ifdef USB_AUDIO_2DOT0
...
/* Reverberation Effect Unit Control Selectors - A.10.? / A.17.8.2 */
#ifdef USB_AUDIO_2DOT0
...
/* Modulation Delay Effect Unit Control Selectors - A.10.? / A.17.8.3 */
#ifdef USB_AUDIO_2DOT0
...
/* Dynamic Range Compressor Effect Unit Control Selectors - A.10.? / A.17.8.4 */
#ifdef USB_AUDIO_2DOT0
...
/*  - Dolby Prologic Control Selectors - A.10.3.2 / A.17.9.2 */
#ifndef USB_AUDIO_2DOT0
/*      AUDIO_ENABLE_CONTROL                    0x01       Common Selector */
/*      AUDIO_MODE_SELECT_CONTROL               0x02       Common Selector */
#else
...
/*  - 3D Stereo Extender Control Selectors - A.10.3.2 / A.17.9.3 */
#ifndef USB_AUDIO_2DOT0
/*      AUDIO_ENABLE_CONTROL                    0x01       Common Selector */
...
/*  - Reverberation Control Selectors - A.10.3.4 / A.? */
#ifndef USB_AUDIO_2DOT0
/*      AUDIO_ENABLE_CONTROL                    0x01       Common Selector */
...
/*  - Chorus Control Selectors - A.10.3.5 / A.? */
#ifndef USB_AUDIO_2DOT0
/*      AUDIO_ENABLE_CONTROL                    0x01       Common Selector */
...
/*  - Dynamic Range Compressor Control Selectors A.10.3.6 / A.? */
#ifndef USB_AUDIO_2DOT0
/*      AUDIO_ENABLE_CONTROL                    0x01       Common Selector */
...
/*  Extension Unit Control Selectors - A.10.4 / A.17.10 */
#ifndef USB_AUDIO_2DOT0
/*      AUDIO_ENABLE_CONTROL                    0x01       Common Selector */
#else
...
/* AudioStreaming Interface Control Selectors - A.? / A.17.11 */
#ifdef USB_AUDIO_2DOT0
...
/* Encoder Control Selectors - A.? / A.17.12 */
#ifdef USB_AUDIO_2DOT0
...
/* MPEG Decoder Control Sleectors - A.? / A.17.13.1 */
#ifdef USB_AUDIO_2DOT0
#define AUDIO_MD_CONTROL_UNDEFINED              0x00
...
/*  Endpoint Control Selectors - A.10.5 / A.17.14 */
#ifndef USB_AUDIO_2DOT0
